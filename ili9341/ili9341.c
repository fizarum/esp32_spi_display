...
static void display_select_region(const spi_display_t* dev, _u16 l, _u16 t,
                                  _u16 r, _u16 b);
static void display_draw_pixel(const spi_display_t* dev, _u16 left, _u16 top,
                               _u16 color);
static void display_draw_pixels(const spi_display_t* dev, _u16 left, _u16 top,
                                _u16 right, _u16 bottom, const _u16* colors,
                                const size_t size);
static bool display_rotate(spi_display_t* dev, const rotation_t rotation);
static bool display_set_color_mode(spi_display_t* dev, const color_mode_t mode);
static void display_set_scroll_area(spi_display_t* dev, _u16 tfa, _u16 vsa,
                                    _u16 bfa);
static void display_reset_scroll_area(spi_display_t* dev, _u16 vsa);
static void display_scroll(spi_display_t* dev, _u16 vsp);
...
// TODO: display_fill_rect()
// TODO: add display_clear()
